                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>                                                                                                <!-- El value contiene una operador ternario en el que por medio de un metodo 'isset()'
                                            ...
                                            <input class="obligatorio d-flex justify-content-start" type="text" name="alfabeticoObligatorio" placeholder="cadena de letras" value="<?php echo (isset($_REQUEST['alfabeticoObligatorio']) ? $_REQUEST['alfabeticoObligatorio'] : '');  ?>">
                                        </td>
                                        <td class="error">
                                    ...
                                    <tr>
                                        ...
                                        <td>                                                                                                <!-- El value contiene una operador ternario en el que por medio de un metodo 'isset()'
                                                                                                                                            comprobamos que exista la variable y no sea 'null'. En el caso verdadero devovleremos el contenido del campo
                                                                                                                                            que contiene '$_REQUEST' , en caso falso sobrescribira el campo a '' .-->
                                            <input class="d-flex justify-content-start" type="text" name="alfabeticoOpcional" placeholder="cadena de letras" value="<?php echo (isset($_REQUEST['alfabeticoOpcional']) ? $_REQUEST['alfabeticoOpcional'] : '');  ?>">
                                        </td>
                                        <td class="error">
                                    ...
                                    <tr>
                                        ...
                                        <td>                                                                                                <!-- El value contiene una operador ternario en el que por medio de un metodo 'isset()'
                                                                                                                                            comprobamos que exista la variable y no sea 'null'. En el caso verdadero devovleremos el contenido del campo
                                                                                                                                            que contiene '$_REQUEST' , en caso falso sobrescribira el campo a '' .-->
                                            <input class="obligatorio d-flex justify-content-start" type="text" placeholder="cadena de letras y numeros" name="alfanumericoObligatorio" value="<?php echo (isset($_REQUEST['alfanumericoObligatorio']) ? $_REQUEST['alfanumericoObligatorio'] : '');  ?>">
                                        </td>
                                        <td class="error">
                                    ...
                                    <tr>
                                        ...
                                        <td>                                                                                                <!-- El value contiene una operador ternario en el que por medio de un metodo 'isset()'
                                                                                                                                            comprobamos que exista la variable y no sea 'null'. En el caso verdadero devovleremos el contenido del campo
                                                                                                                                            que contiene '$_REQUEST' , en caso falso sobrescribira el campo a '' .-->
                                            <input class="d-flex justify-content-start" type="text" name="alfanumericoOpcional" placeholder="cadena de letras y numeros" value="<?php echo (isset($_REQUEST['alfanumericoOpcional']) ? $_REQUEST['alfanumericoOpcional'] : '');  ?>">
                                        </td>
                                        <td class="error">
                                    ...
                                    <tr>
                                        ...
                                        <td>                                                                                                <!-- El value contiene una operador ternario en el que por medio de un metodo 'isset()'
                                                                                                                                            comprobamos que exista la variable y no sea 'null'. En el caso verdadero devovleremos el contenido del campo
                                                                                                                                            que contiene '$_REQUEST' , en caso falso sobrescribira el campo a '' .-->
                                            <input class="obligatorio d-flex justify-content-start" type="text" name="enteroObligatorio" placeholder="numeros enteros" value="<?php echo (isset($_REQUEST['enteroObligatorio']) ? $_REQUEST['enteroObligatorio'] : '');  ?>">
                                        </td>
                                        <td class="error">
                                    ...
                                    <tr>
                                        ...
                                        <td>                                                                                                <!-- El value contiene una operador ternario en el que por medio de un metodo 'isset()'
                                                                                                                                            comprobamos que exista la variable y no sea 'null'. En el caso verdadero devovleremos el contenido del campo
                                                                                                                                            que contiene '$_REQUEST' , en caso falso sobrescribira el campo a '' .-->
                                            <input class="d-flex justify-content-start" type="text" name="enteroOpcional" placeholder="numeros enteros" value="<?php echo (isset($_REQUEST['enteroOpcional']) ? $_REQUEST['enteroOpcional'] : '');  ?>">
                                        </td>
                                        <td class="error">
                                    ...
                                    <tr>
                                        ...
                                        <td>                                                                                                <!-- El value contiene una operador ternario en el que por medio de un metodo 'isset()'
                                                                                                                                            comprobamos que exista la variable y no sea 'null'. En el caso verdadero devovleremos el contenido del campo
                                                                                                                                            que contiene '$_REQUEST' , en caso falso sobrescribira el campo a '' .-->
                                            <input class="obligatorio d-flex justify-content-start" type="text" name="floatObligatorio" placeholder="numeros reales" value="<?php echo (isset($_REQUEST['floatObligatorio']) ? $_REQUEST['floatObligatorio'] : '');  ?>">
                                        </td>
                                        <td class="error">
                                    ...
                                    <tr>
                                        ...
                                        <td>                                                                                                <!-- El value contiene una operador ternario en el que por medio de un metodo 'isset()'
                                                                                                                                            comprobamos que exista la variable y no sea 'null'. En el caso verdadero devovleremos el contenido del campo
                                                                                                                                            que contiene '$_REQUEST' , en caso falso sobrescribira el campo a '' .-->
                                            <input class="d-flex justify-content-start" type="text" name="floatOpcional" placeholder="numeros reales" value="<?php echo (isset($_REQUEST['floatOpcional']) ? $_REQUEST['floatOpcional'] : '');  ?>">
                                        </td>
                                        <td class="error">
                                    ...
                                    <tr>
                                        ...
                                        <td>                                                                                                <!-- El value contiene una operador ternario en el que por medio de un metodo 'isset()'
                                                                                                                                            comprobamos que exista la variable y no sea 'null'. En el caso verdadero devovleremos el contenido del campo
                                                                                                                                            que contiene '$_REQUEST' , en caso falso sobrescribira el campo a '' .-->
                                            <input class="obligatorio d-flex justify-content-start" type="text" name="correoObligatorio" placeholder="tunombre@dominio.com" value="<?php echo (isset($_REQUEST['correoObligatorio']) ? $_REQUEST['correoObligatorio'] : '');  ?>">
                                        </td>
                                        <td class="error">
                                    ...
                                    <tr>
                                        ...
                                        <td>                                                                                                <!-- El value contiene una operador ternario en el que por medio de un metodo 'isset()'
                                                                                                                                            comprobamos que exista la variable y no sea 'null'. En el caso verdadero devovleremos el contenido del campo
                                                                                                                                            que contiene '$_REQUEST' , en caso falso sobrescribira el campo a '' .-->
                                            <input class="d-flex justify-content-start" type="text" name="correoOpcional" placeholder="tunombre@dominio.com" value="<?php echo (isset($_REQUEST['correoOpcional']) ? $_REQUEST['correoOpcional'] : '');  ?>">
                                        </td>
                                        <td class="error">
                                    ...
                                    <tr>
                                        ...
                                        <td>                                                                                                <!-- El value contiene una operador ternario en el que por medio de un metodo 'isset()'
                                                                                                                                            comprobamos que exista la variable y no sea 'null'. En el caso verdadero devovleremos el contenido del campo
                                                                                                                                            que contiene '$_REQUEST' , en caso falso sobrescribira el campo a '' .-->
                                            <input class="obligatorio d-flex justify-content-start" type="text" name="urlObligatorio" placeholder="https://www.loquesea.com" value="<?php echo (isset($_REQUEST['urlObligatorio']) ? $_REQUEST['urlObligatorio'] : '');  ?>">
                                        </td>
                                        <td class="error">
                                    ...
                                    <tr>
                                        ...
                                        <td>                                                                                                <!-- El value contiene una operador ternario en el que por medio de un metodo 'isset()'
                                                                                                                                            comprobamos que exista la variable y no sea 'null'. En el caso verdadero devovleremos el contenido del campo
                                                                                                                                            que contiene '$_REQUEST' , en caso falso sobrescribira el campo a '' .-->
                                            <input class="d-flex justify-content-start" type="text" name="urlOpcional" placeholder="https://www.loquesea.com" value="<?php echo (isset($_REQUEST['urlOpcional']) ? $_REQUEST['urlOpcional'] : '');  ?>">
                                        </td>
                                        <td class="error">
                                    ...
                                    <tr>
                                        ...
                                        <td>                                                                                                <!-- El value contiene una operador ternario en el que por medio de un metodo 'isset()'
                                                                                                                                            comprobamos que exista la variable y no sea 'null'. En el caso verdadero devovleremos el contenido del campo
                                                                                                                                            que contiene '$_REQUEST' , en caso falso sobrescribira el campo a '' .-->
                                            <input class="obligatorio d-flex justify-content-start" type="text" name="fechaObligatorio" placeholder="Año-Mes-dia/AAAA-MM-DD" value="<?php echo (isset($_REQUEST['fechaObligatorio']) ? $_REQUEST['fechaObligatorio'] : '');  ?>">
                                        </td>
                                        <td class="error">
                                    ...
                                    <tr>
                                        ...
                                        <td>                                                                                                <!-- El value contiene una operador ternario en el que por medio de un metodo 'isset()'
                                                                                                                                            comprobamos que exista la variable y no sea 'null'. En el caso verdadero devovleremos el contenido del campo
                                                                                                                                            que contiene '$_REQUEST' , en caso falso sobrescribira el campo a '' .-->
                                            <input class="d-flex justify-content-start" type="text" name="fechaOpcional" placeholder="Año-Mes-dia/AAAA-MM-DD" value="<?php echo (isset($_REQUEST['fechaOpcional']) ? $_REQUEST['fechaOpcional'] : '');  ?>">
                                        </td>
                                        <td class="error">
                                    ...
                                    <tr>
                                        ...
                                        <td>                                                                                                <!-- El value contiene una operador ternario en el que por medio de un metodo 'isset()'
                                                                                                                                            comprobamos que exista la variable y no sea 'null'. En el caso verdadero devovleremos el contenido del campo
                                                                                                                                            que contiene '$_REQUEST' , en caso falso sobrescribira el campo a '' .-->
                                            <input class="obligatorio d-flex justify-content-start" type="text" name="dniObligatorio" placeholder="12345678X" value="<?php echo (isset($_REQUEST['dniObligatorio']) ? $_REQUEST['dniObligatorio'] : '');  ?>">
                                        </td>
                                        <td class="error">
                                    ...
                                    <tr>
                                        ...
                                        <td>                                                                                                <!-- El value contiene una operador ternario en el que por medio de un metodo 'isset()'
                                                                                                                                            comprobamos que exista la variable y no sea 'null'. En el caso verdadero devovleremos el contenido del campo
                                                                                                                                            que contiene '$_REQUEST' , en caso falso sobrescribira el campo a '' .-->
                                            <input class="d-flex justify-content-start" type="text" name="dniOpcional" placeholder="12345678X" value="<?php echo (isset($_REQUEST['dniOpcional']) ? $_REQUEST['dniOpcional'] : '');  ?>">
                                        </td>
                                        <td class="error">
                                    ...
                                    <tr>
                                        ...
                                        <td>                                                                                                <!-- El value contiene una operador ternario en el que por medio de un metodo 'isset()'
                                                                                                                                            comprobamos que exista la variable y no sea 'null'. En el caso verdadero devovleremos el contenido del campo
                                                                                                                                            que contiene '$_REQUEST' , en caso falso sobrescribira el campo a '' .-->
                                            <input class="obligatorio d-flex justify-content-start" type="text" name="cpObligatorio" placeholder="49660" value="<?php echo (isset($_REQUEST['cpObligatorio']) ? $_REQUEST['cpObligatorio'] : '');  ?>">
                                        </td>
                                        <td class="error">
                                    ...
                                    <tr>
                                        ...
                                        <td>                                                                                                <!-- El value contiene una operador ternario en el que por medio de un metodo 'isset()'
                                                                                                                                            comprobamos que exista la variable y no sea 'null'. En el caso verdadero devovleremos el contenido del campo
                                                                                                                                            que contiene '$_REQUEST' , en caso falso sobrescribira el campo a '' .-->
                                            <input class="d-flex justify-content-start" type="text" name="cpOpcional" placeholder="49660" value="<?php echo (isset($_REQUEST['cpOpcional']) ? $_REQUEST['cpOpcional'] : '');  ?>">
                                        </td>
                                        <td class="error">
                                    ...
                                    <tr>
                                        ...
                                        <td>                                                                                                <!-- El value contiene una operador ternario en el que por medio de un metodo 'isset()'
                                                                                                                                            comprobamos que exista la variable y no sea 'null'. En el caso verdadero devovleremos el contenido del campo
                                                                                                                                            que contiene '$_REQUEST' , en caso falso sobrescribira el campo a '' .-->
                                            <input class="obligatorio d-flex justify-content-start" type="password" placeholder="paso" name="password Obligatorio" value="<?php echo (isset($_REQUEST['passwordObligatorio']) ? $_REQUEST['passwordObligatorio'] : '');  ?>">
                                        </td>
                                        <td class="error">
                                    ...
                                    <tr>
                                        ...
                                        <td>                                                                                                <!-- El value contiene una operador ternario en el que por medio de un metodo 'isset()'
                                                                                                                                            comprobamos que exista la variable y no sea 'null'. En el caso verdadero devovleremos el contenido del campo
                                                                                                                                            que contiene '$_REQUEST' , en caso falso sobrescribira el campo a '' .-->
                                            <input class="d-flex justify-content-start" type="password" name="passwordOpcional" placeholder="P@ssw0rd" value="<?php echo (isset($_REQUEST['passwordOpcional']) ? $_REQUEST['passwordOpcional'] : '');  ?>">
                                        </td>
                                        <td class="error">
                                    ...
                                    <tr>
                                        ...
                                        <td>                                                                                                <!-- El value contiene una operador ternario en el que por medio de un metodo 'isset()'
                                                                                                                                            comprobamos que exista la variable y no sea 'null'. En el caso verdadero devovleremos el contenido del campo
                                                                                                                                            que contiene '$_REQUEST' , en caso falso sobrescribira el campo a '' .-->
                                            <input class="obligatorio d-flex justify-content-start" type="tel" name="telefonoObligatorio" placeholder="654321000" value="<?php echo (isset($_REQUEST['telefonoObligatorio']) ? $_REQUEST['telefonoObligatorio'] : '');  ?>">
                                        </td>
                                        <td class="error">
                                    ...
                                    <tr>
                                        ...
                                        <td>                                                                                                <!-- El value contiene una operador ternario en el que por medio de un metodo 'isset()'
                                                                                                                                            comprobamos que exista la variable y no sea 'null'. En el caso verdadero devovleremos el contenido del campo
                                                                                                                                            que contiene '$_REQUEST' , en caso falso sobrescribira el campo a '' .-->
                                            <input class="d-flex justify-content-start" type="tel" name="telefonoOpcional" placeholder="654321000" value="<?php echo (isset($_REQUEST['telefonoOpcional']) ? $_REQUEST['telefonoOpcional'] : '');  ?>">
                                        </td>
                                        <td class="error">
                                    ...
                                    <tr>
                                        ...
                                        <td>                                                                                                <!-- El value contiene una operador ternario en el que por medio de un metodo 'isset()'
                                                                                                                                            comprobamos que exista la variable y no sea 'null'. En el caso verdadero devovleremos el contenido del campo
                                                                                                                                            que contiene '$_REQUEST' , en caso falso sobrescribira el campo a '' .-->
                                            <input class="obligatorio d-flex justify-content-start" type="file" name="file obligatorio" value="<?php echo (isset($_REQUEST['fileObligatorio']) ? $_REQUEST['fileObligatorio'] : '');  ?>">
                                        </td>
                                        <td class="error">
                                    ...
                                    <tr>
                                        ...
                                        <td>                                                                                                
                                            <select class="obligatorio" name="listaObligatorio">
                                                <option value="listItem1" <?php if(isset($_REQUEST['listaObligatorio'])){ echo 'selected'; }?>>list1</option> <!-- Si el campo es correcto se queda seleccionado. -->
                                                <option value="listItem2" <?php if(isset($_REQUEST['listaObligatorio'])){ echo 'selected'; }?>>list2</option> <!-- Si el campo es correcto se queda seleccionado. -->
                                                <option value="listItem3" <?php if(isset($_REQUEST['listaObligatorio'])){ echo 'selected'; }?>>list3</option> <!-- Si el campo es correcto se queda seleccionado. -->
                                          </select> 
                                        </td>
                                        <td class="error">
                                    ...
                                    <tr>
                                        ...
                                        <td class="obligatorio">                                                                                                
                                            ...
                                            <label for="radioButtonObligatorio">radioButton1</label>
                                            ...
                                            <label for="radioButtonObligatorio">radioButton2</label>
                                        </td>
                                        <td class="error">
                                    ...
                                    <tr>
                                        ...
                                        <td>                                                                                                    <!-- En el siguiente 'if' comprobamos que en el array '$aErrores' , guarde valor 'NULL' y que la variable ese declarada y sin 
                                            ...
                                            <textarea class="obligatorio d-flex justify-content-start" rows="4" cols="50" name="textAreaObligatorio" placeholder="cadena de letras y numeros"><?php if ($aErrores['textAreaObligatorio'] == null && isset($_REQUEST['textAreaObligatorio'])) {echo ($_REQUEST['textAreaObligatorio']);}?></textarea>
                                        </td>
                                        <td class="error">
                                    ...
                                    <tr>
                                        ...
                                        <td>                                                                                                    <!-- En el siguiente 'if' comprobamos que en el array '$aErrores' , guarde valor 'NULL' y que la variable ese declarada y sin 
                                            ...
                                            <textarea class="d-flex justify-content-start" rows="4" cols="50" name="textAreaOpcional" placeholder="cadena de letras y numeros"><?php if ($aErrores['textAreaOpcional'] == null && isset($_REQUEST['textAreaOpcional'])) {echo ($_REQUEST['textAreaOpcional']);} ?></textarea>
                                        </td>
                                        <td class="error">
