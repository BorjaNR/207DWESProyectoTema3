        ...
        <main style="margin-bottom: 75px">
            ...
            if (isset($_REQUEST['enviar'])) {
                ...
                $aErrores = [
                    ...
                    'fechaCreacion' => validacionFormularios::validarFecha($_REQUEST['fechaCreacion'], "01/01/2200", date('d-m-Y'), 1),//Valido que la fecha maxima sea en 2200 y la minima la del dia en el que se realiza el formulario
            ...
            if ($entradaOK) {
                ...
                <form class="w-40 position-absolute top-50 start-50 translate-middle" name="fomrulario" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control bg-warning" name="fechaCreacion" placeholder="dd/mm/aaaa" value="<?php echo (isset($_REQUEST['fechaCreacion']) ? $_REQUEST['fechaCreacion'] : ''); ?>">
